 ...
 */
public class DoubleMarkerConfigMutation implements EvolutionaryOperator<TypedMarkerPassingConfig> {

    private final NumberGenerator<Probability> mutationProbability;


    public DoubleMarkerConfigMutation(Probability probability) {
