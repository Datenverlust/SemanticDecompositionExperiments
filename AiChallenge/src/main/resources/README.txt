...
The nexte steps are only to be done if no settings.xml has been provided.
...
5. Download source of deeplerning4j:    git clone https://github.com/deeplearning4j/deeplearning4j

6. Install Conova: mvn clean install
7. Install deeplerning4j: mvn clean install
