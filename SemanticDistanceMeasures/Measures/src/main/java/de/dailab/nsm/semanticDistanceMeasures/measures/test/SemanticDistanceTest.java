...
//        datasets.add(stanfordRareWordSimilarityDataset);
         ...
         */
        Collections.sort((List<DataExample>) testSynonymPairs, new Comparator<DataExample>() {
            @Override
            public int compare(DataExample o1, DataExample o2) {
                if (o1.getTrueResult() - o2.getTrueResult() < 0) {
                    return 1;
                } else if (o1.getTrueResult() == o2.getTrueResult()) {
                    return 0;
                } else {
                    return -1;
                }
