    ...
    public Evolution() {
        ...
        engine.addEvolutionObserver(new EvolutionObserver<TypedMarkerPassingConfig>() {
            ...
            public void populationUpdate(PopulationData<? extends TypedMarkerPassingConfig> populationData) {
                ...
                //Logger.logBestCandidate(populationData.getGenerationNumber() ,populationData.getBestCandidate());
                //Logger.logMeanGeneration(populationData.getGenerationNumber(),populationData.getMeanFitness(),populationData.getElapsedTime());
